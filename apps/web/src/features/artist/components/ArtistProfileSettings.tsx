  ...
  async function onSubmit(values: ProfileFormValues) {
    ...
    try {
      ...
      reset({
        ...
        appleMusicUrl: updated.appleMusicUrl ?? '',
        amazonMusicUrl: updated.amazonMusicUrl ?? '',
        deezerUrl: updated.deezerUrl ?? '',
        tidalUrl: updated.tidalUrl ?? '',
        beatportUrl: updated.beatportUrl ?? '',
        traxsourceUrl: updated.traxsourceUrl ?? '',
