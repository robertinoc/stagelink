        ...
        <section id="features" className="px-6 py-20">
          <div className="mx-auto max-w-7xl">
            <div className="max-w-2xl">
              <p className="text-sm font-medium uppercase tracking-[0.2em] text-fuchsia-300">Features</p>
        ...
        <section id="how-it-works" className="px-6 py-20">
          <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.2fr_0.8fr]">
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-8">
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-3">
                {[
                  ...
                  <div key={item.step} className="rounded-3xl border border-white/10 bg-zinc-900/80 p-5">
            ...
            <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-8">
              <p className="text-sm font-medium uppercase tracking-[0.2em] text-fuchsia-300">Content blocks</p>
              <h3 className="mt-3 text-2xl font-semibold tracking-tight">Mix and match your stage.</h3>
        ...
        <section className="px-6 py-20">
          <div className="mx-auto max-w-7xl rounded-[2rem] border border-white/10 bg-white/5 p-8 md:p-12">
            <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
              <div>
                <p className="text-sm font-medium uppercase tracking-[0.2em] text-fuchsia-300">Why it wins</p>
                <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-5xl">
              ...
              <div className="grid gap-4">
                {[
                  ...
                  <div key={point} className="rounded-2xl border border-white/10 bg-zinc-900/70 px-5 py-4 text-sm text-zinc-200">
                    {point}
                  </div>
                ))}
              </div>
              ...
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="mt-8 space-y-3 text-sm text-zinc-200">
                    {plan.items.map((item) => (
                      <div key={item} className="rounded-2xl border border-white/10 bg-zinc-900/60 px-4 py-3">
                        {item}
                      </div>
                    ))}
                  </div>
