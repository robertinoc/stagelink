...
| Umami                                       | Behind product/admin analytics when public env vars are set                                                                                          | Umami provider/self-host      | Provider-managed         | Behind only; no PII event properties; region, retention, and IP handling need confirmation |
