...
| Umami                                       | StageLink Platform analytics when public env vars are set                                                                                            | Umami provider/self-host      | Provider-managed         | Consent-gated; excludes Behind and public artist pages in v1; region, retention, and IP handling need confirmation |
