...
| Umami                    | StageLink Platform analytics                | Consent-gated platform page views, UTM parameters, `auth_*` events | Processor if configured under DPA/service-provider terms                                                        | Confirm Cloud/self-host region, DPA, transfer posture, retention, IP handling |
