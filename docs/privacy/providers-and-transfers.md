...
| Umami                    | Behind product/admin analytics              | Behind page views, referrers, device context, `behind_*` events | Processor if configured under DPA/service-provider terms                                                        | Confirm Cloud/self-host region, DPA, transfer posture, retention, IP handling |
