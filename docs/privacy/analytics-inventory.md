...
Umami is documented as possible/future, but no active Umami runtime usage,
script, package call, or `NEXT_PUBLIC_UMAMI` configuration was found.
...
| Umami                               | None active                                                                                                                            | Future analytics if enabled                              | None currently                                                      | Must be analytics consent-gated before enabling                                                                                        | TBD                                                      | TBD                                                                    | TBD                                                                                     | Future risk |
...
- Umami must stay disabled or be added behind consent with documentation.
