...
| Analytics | Product and public-page analytics, artist dashboard metrics, PostHog, Behind-only Umami | `sl_consent`, `sl_ac`, PostHog browser identifiers after opt-in, public page/link/smart-link analytics events, Umami script/runtime storage on Behind | Consent for public/artist-facing analytics; internal admin/product analytics requires documented lawful basis | Yes for public/artist-facing analytics |
